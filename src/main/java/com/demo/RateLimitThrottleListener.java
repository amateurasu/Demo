...
/**
 * @author aayush Listener interface’s implementation to receive the threshold breach notifications. Application may
 *     take appropriate action after receiving this callback
 */
